...
const AbstractGameEventListener = Java.type(
    'baritone.api.event.listener.AbstractGameEventListener'
) as typeof baritone.api.event.listener.AbstractGameEventListener;
const AbstractSchematic = Java.type(
    'baritone.api.schematic.AbstractSchematic'
) as typeof baritone.api.schematic.AbstractSchematic;
const ActionCosts = Java.type(
    'baritone.api.pathing.movement.ActionCosts'
) as typeof baritone.api.pathing.movement.ActionCosts;
...
const BlockById: typeof baritone.api.command.datatypes.BlockById = Java.type(
    'baritone.api.command.datatypes.BlockById'
);
const BlockChangeEvent: typeof baritone.api.event.events.BlockChangeEvent = Java.type(
    'baritone.api.event.events.BlockChangeEvent'
);
const BlockInteractEvent: typeof baritone.api.event.events.BlockInteractEvent = Java.type(
    'baritone.api.event.events.BlockInteractEvent'
);
const BlockInteractEvent$Type: typeof baritone.api.event.events.BlockInteractEvent$Type = Java.type(
    'baritone.api.event.events.BlockInteractEvent$Type'
);
const BlockOptionalMeta: typeof baritone.api.utils.BlockOptionalMeta = Java.type(
    'baritone.api.utils.BlockOptionalMeta'
);
const BlockOptionalMetaLookup: typeof baritone.api.utils.BlockOptionalMetaLookup = Java.type(
...
const Cancellable: typeof baritone.api.event.events.type.Cancellable = Java.type(
...
const ChunkEvent$Type: typeof baritone.api.event.events.ChunkEvent$Type = Java.type(
...
const CompositeSchematic: typeof baritone.api.schematic.CompositeSchematic = Java.type(
    'baritone.api.schematic.CompositeSchematic'
);
const EntityClassById: typeof baritone.api.command.datatypes.EntityClassById = Java.type(
    'baritone.api.command.datatypes.EntityClassById'
);
const EventState: typeof baritone.api.event.events.type.EventState = Java.type(
...
const ForBlockOptionalMeta: typeof baritone.api.command.datatypes.ForBlockOptionalMeta = Java.type(
    'baritone.api.command.datatypes.ForBlockOptionalMeta'
);
const ForDirection: typeof baritone.api.command.datatypes.ForDirection = Java.type(
    'baritone.api.command.datatypes.ForDirection'
);
const ForWaypoints: typeof baritone.api.command.datatypes.ForWaypoints = Java.type(
...
const GoalComposite: typeof baritone.api.pathing.goals.GoalComposite = Java.type(
    'baritone.api.pathing.goals.GoalComposite'
);
const GoalGetToBlock: typeof baritone.api.pathing.goals.GoalGetToBlock = Java.type(
    'baritone.api.pathing.goals.GoalGetToBlock'
);
const GoalInverted: typeof baritone.api.pathing.goals.GoalInverted = Java.type(
...
const GoalStrictDirection: typeof baritone.api.pathing.goals.GoalStrictDirection = Java.type(
    'baritone.api.pathing.goals.GoalStrictDirection'
);
const GoalTwoBlocks: typeof baritone.api.pathing.goals.GoalTwoBlocks = Java.type(
...
const IAimProcessor: typeof baritone.api.behavior.look.IAimProcessor = Java.type(
    'baritone.api.behavior.look.IAimProcessor'
);
const IArgConsumer: typeof baritone.api.command.argument.IArgConsumer = Java.type(
    'baritone.api.command.argument.IArgConsumer'
);
const IArgParser: typeof baritone.api.command.argparser.IArgParser = Java.type(
    'baritone.api.command.argparser.IArgParser'
);
const IArgParserManager: typeof baritone.api.command.argparser.IArgParserManager = Java.type(
...
const IBaritoneChatControl: typeof baritone.api.command.IBaritoneChatControl = Java.type(
    'baritone.api.command.IBaritoneChatControl'
);
const IBaritoneProcess: typeof baritone.api.process.IBaritoneProcess = Java.type(
...
const ICancellable: typeof baritone.api.event.events.type.ICancellable = Java.type(
...
const ICommandArgument: typeof baritone.api.command.argument.ICommandArgument = Java.type(
    'baritone.api.command.argument.ICommandArgument'
);
const ICommandManager: typeof baritone.api.command.manager.ICommandManager = Java.type(
...
const ICustomGoalProcess: typeof baritone.api.process.ICustomGoalProcess = Java.type(
    'baritone.api.process.ICustomGoalProcess'
);
const IDatatype: typeof baritone.api.command.datatypes.IDatatype = Java.type(
    'baritone.api.command.datatypes.IDatatype'
);
const IDatatypeContext: typeof baritone.api.command.datatypes.IDatatypeContext = Java.type(
    'baritone.api.command.datatypes.IDatatypeContext'
);
const IDatatypeFor: typeof baritone.api.command.datatypes.IDatatypeFor = Java.type(
    'baritone.api.command.datatypes.IDatatypeFor'
);
const IDatatypePost: typeof baritone.api.command.datatypes.IDatatypePost = Java.type(
    'baritone.api.command.datatypes.IDatatypePost'
);
const IDatatypePostFunction: typeof baritone.api.command.datatypes.IDatatypePostFunction = Java.type(
    'baritone.api.command.datatypes.IDatatypePostFunction'
);
...
const IGameEventListener: typeof baritone.api.event.listener.IGameEventListener = Java.type(
    'baritone.api.event.listener.IGameEventListener'
);
const IGetToBlockProcess: typeof baritone.api.process.IGetToBlockProcess = Java.type(
    'baritone.api.process.IGetToBlockProcess'
);
const IGoalRenderPos: typeof baritone.api.utils.interfaces.IGoalRenderPos = Java.type(
    'baritone.api.utils.interfaces.IGoalRenderPos'
);
const IInputOverrideHandler: typeof baritone.api.utils.IInputOverrideHandler = Java.type(
...
const IPathExecutor: typeof baritone.api.pathing.path.IPathExecutor = Java.type(
...
const IPathingBehavior: typeof baritone.api.behavior.IPathingBehavior = Java.type(
    'baritone.api.behavior.IPathingBehavior'
);
const IPathingControlManager: typeof baritone.api.pathing.calc.IPathingControlManager = Java.type(
...
const IPlayerController: typeof baritone.api.utils.IPlayerController = Java.type(
...
const ISchematicFormat: typeof baritone.api.schematic.format.ISchematicFormat = Java.type(
    'baritone.api.schematic.format.ISchematicFormat'
);
const ISchematicSystem: typeof baritone.api.schematic.ISchematicSystem = Java.type(
...
const ISelectionManager: typeof baritone.api.selection.ISelectionManager = Java.type(
    'baritone.api.selection.ISelectionManager'
);
const IStaticSchematic: typeof baritone.api.schematic.IStaticSchematic = Java.type(
    'baritone.api.schematic.IStaticSchematic'
);
const ITickableAimProcessor: typeof baritone.api.behavior.look.ITickableAimProcessor = Java.type(
...
const IWaypointCollection: typeof baritone.api.cache.IWaypointCollection = Java.type(
...
const MirroredSchematic: typeof baritone.api.schematic.MirroredSchematic = Java.type(
    'baritone.api.schematic.MirroredSchematic'
);
const MovementStatus: typeof baritone.api.pathing.movement.MovementStatus = Java.type(
    'baritone.api.pathing.movement.MovementStatus'
);
const NearbyPlayer: typeof baritone.api.command.datatypes.NearbyPlayer = Java.type(
    'baritone.api.command.datatypes.NearbyPlayer'
);
const NotificationHelper: typeof baritone.api.utils.NotificationHelper = Java.type(
    'baritone.api.utils.NotificationHelper'
);
const Overrideable: typeof baritone.api.event.events.type.Overrideable = Java.type(
    'baritone.api.event.events.type.Overrideable'
);
const PacketEvent: typeof baritone.api.event.events.PacketEvent = Java.type('baritone.api.event.events.PacketEvent');
const PathCalculationResult: typeof baritone.api.utils.PathCalculationResult = Java.type(
...
const PathingCommandType: typeof baritone.api.process.PathingCommandType = Java.type(
    'baritone.api.process.PathingCommandType'
);
const PlayerUpdateEvent: typeof baritone.api.event.events.PlayerUpdateEvent = Java.type(
...
const RelativeBlockPos: typeof baritone.api.command.datatypes.RelativeBlockPos = Java.type(
    'baritone.api.command.datatypes.RelativeBlockPos'
);
const RelativeCoordinate: typeof baritone.api.command.datatypes.RelativeCoordinate = Java.type(
    'baritone.api.command.datatypes.RelativeCoordinate'
);
const RelativeFile: typeof baritone.api.command.datatypes.RelativeFile = Java.type(
    'baritone.api.command.datatypes.RelativeFile'
);
const RelativeGoal: typeof baritone.api.command.datatypes.RelativeGoal = Java.type(
    'baritone.api.command.datatypes.RelativeGoal'
);
const RelativeGoalBlock: typeof baritone.api.command.datatypes.RelativeGoalBlock = Java.type(
    'baritone.api.command.datatypes.RelativeGoalBlock'
);
const RelativeGoalXZ: typeof baritone.api.command.datatypes.RelativeGoalXZ = Java.type(
    'baritone.api.command.datatypes.RelativeGoalXZ'
);
const RelativeGoalYLevel: typeof baritone.api.command.datatypes.RelativeGoalYLevel = Java.type(
...
const ReplaceSchematic: typeof baritone.api.schematic.ReplaceSchematic = Java.type(
    'baritone.api.schematic.ReplaceSchematic'
);
const RotatedSchematic: typeof baritone.api.schematic.RotatedSchematic = Java.type(
...
const RotationMoveEvent: typeof baritone.api.event.events.RotationMoveEvent = Java.type(
    'baritone.api.event.events.RotationMoveEvent'
);
const RotationMoveEvent$Type: typeof baritone.api.event.events.RotationMoveEvent$Type = Java.type(
...
const SprintStateEvent: typeof baritone.api.event.events.SprintStateEvent = Java.type(
...
const SubstituteSchematic: typeof baritone.api.schematic.SubstituteSchematic = Java.type(
    'baritone.api.schematic.SubstituteSchematic'
);
const TabCompleteEvent: typeof baritone.api.event.events.TabCompleteEvent = Java.type(
...
const TickEvent$Type: typeof baritone.api.event.events.TickEvent$Type = Java.type(
